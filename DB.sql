...
HisItemId varchar(20) NOT NULL ,
HisPrice double(10,2) NOT NULL ,
GetTimeVersion timestamp,
...
CREATE VIEW IDPRICE AS SELECT CurItemId,CurPrice FROM CURRENT;

CREATE INDEX INDEX_HisItemId ON HISTORY(HisItemId);

CREATE INDEX INDEX_CurItemId ON CURRENT(CurItemId);